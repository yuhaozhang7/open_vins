...
void UpdaterMSCKF::update(State *state, std::vector<Feature*>& feature_vec) {
    ...
    std::cout<<"[MSCKF-UP]: " << (rT1-rT0).total_microseconds() * 1e-6 << " seconds to clean" << std::endl;
    std::cout<<"[MSCKF-UP]: " << (rT2-rT1).total_microseconds() * 1e-6 << " seconds to triangulate" << std::endl;
    std::cout<<"[MSCKF-UP]: " << (rT3-rT2).total_microseconds() * 1e-6 << " seconds create system (" << (int)feature_vec.size() << " features)" << std::endl;
    std::cout<<"[MSCKF-UP]: " << (rT4-rT3).total_microseconds() * 1e-6 << " seconds compress system" << std::endl;
    std::cout<<"[MSCKF-UP]: " << (rT5-rT4).total_microseconds() * 1e-6 << " seconds update state (" << (int)res_big.rows() << " size)" << std::endl;
    std::cout<<"[MSCKF-UP]: " << (rT5-rT1).total_microseconds() * 1e-6 << " seconds total"<< std::endl;
